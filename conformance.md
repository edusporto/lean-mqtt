...
**Includes**:
* packet format details (field order, presence, values),
* data type constraints (UTF-8, field values),
* static validation rules,
* how to handle malformed packets.
...
* rules for behavior and state transitions,
* message flow definitions (QoS),
* and session management.

### Packet data/order details

**Includes**:
* rules that constrain packet contents or order based on protocol state or the contents of *other* packets.
* request/response pairings and handshakes.
...
* Rules defining behavior for Session, Will, Retain, Subscriptions, QoS flows, and Authentication.
...
**Includes**:
* rules that constrain behavior based on *negotiated limits*.
* handling of Maximum Packet Size, Receive Maximum (flow control), and Topic Alias Maximum.
...
## Transport-related normative statements

**Includes**:
* requirements for the underlying transport layer, such as TCP.
* rules for transport-specific bindings, like WebSocket.
